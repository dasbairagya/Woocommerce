...
?>
<div id="reviews" class="woocommerce-Reviews rating-custom">
	<div id="comments">
		...
		<div id="review_form_wrapper">
            ...
            <input name="%1$s" type="submit" id="%2$s" class="%3$s btn btn-primary" value="%4$s" />
					...
					if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
						$comment_form['comment_field'] = '<div class="comment-form-rating rating-custom"><label for="rating">' . esc_html__( 'Your rating', 'woocommerce' ) . '</label><select name="rating" id="rating" aria-required="true" required>
